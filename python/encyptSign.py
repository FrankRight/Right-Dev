...
def sign(pub_key):
    ...
    for i in pub_key:
        i = str(i)
        each_letter = hashlib.md5(i.encode('utf-8')).hexdigest()
        
        signed.append(each_letter)
...
if(choose == '1'):
    ...
    signature = sign(public)
    sign_str = ''.join(signature)
    enc_msg += [sign_str]
    print("Your sent encrypted message is as follows: \n", enc_msg)
    # print("\nThe sign is: ",  sign_str)
